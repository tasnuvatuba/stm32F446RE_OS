...
typedef struct {
  volatile uint32_t CTRL; // e n a bl e SysT ick , c l o c k source , s y s t i c k i n t e r r u p t and coun t f l a g
  volatile uint32_t LOAD; // 24 b i t s −− Reload R e g i s t e r ; maximum coun t
  volatile uint32_t VAL; // Curren t coun t v al u e s i m i l i a r t o ‘CNT ’ o f t ime r
  volatile uint32_t CALIB; // C a l i b r a t i o n R e g i s t e r
} SysTick_Typedef ;
